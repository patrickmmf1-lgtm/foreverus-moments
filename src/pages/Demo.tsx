...
const demoMonthlyPhotos = [{
  month_key: 'jan',
  month_number: 1,
  photo_url: '/lovable-uploads/demo-couple-photo.jpg'
}, {
  month_key: 'fev',
  month_number: 2,
  photo_url: '/lovable-uploads/demo-couple-photo.jpg'
  ...
  return <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative h-screen w-full overflow-hidden pt-10">
        ...
        <div className="absolute inset-0">
          <img src={page.photo_url} alt="Foto" className="w-full h-full object-cover" />
        ...
        <div className="max-w-lg mx-auto space-y-6">
          ...
          scale: 1
            ...
            <div className="flex items-center gap-3">
              ...
              <Button variant="outline" size="icon" className="w-12 h-12 rounded-xl" onClick={handleRefresh} disabled={!canReroll}>
                <RefreshCw className="w-5 h-5" />
              </Button>

              {showFavorites && <Button variant="outline" size="icon" className={`w-12 h-12 rounded-xl ${isFavorited ? 'text-rose-500 border-rose-500/50' : ''}`} onClick={handleFavorite}>
          ...
          y: 0
              ...
              return <div key={favId} className="flex items-center gap-3 p-3 rounded-xl bg-background/50">
          ...
          <QRCodeCard pageSlug={page.slug} name1={page.name1} name2={page.name2} startDate={page.start_date} plan="29_90" />

          {/* Premium: Year Album */}
          <YearAlbum pageId={page.id} pageSlug={page.slug} plan="29_90" />
